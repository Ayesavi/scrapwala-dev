...
abstract class _$$DataImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ScrapCategoryModel> categories, List<ScrapModel> scraps});
}
...
class _$DataImpl implements _Data {
  const _$DataImpl(
      {required final List<ScrapCategoryModel> categories,
      required final List<ScrapModel> scraps})
  ...
  @override
  String toString() {
    return 'HomePageControllerState.data(categories: $categories, scraps: $scraps)';
  }
...
abstract class _Data implements HomePageControllerState {
  const factory _Data(
      {required final List<ScrapCategoryModel> categories,
      required final List<ScrapModel> scraps}) = _$DataImpl;
